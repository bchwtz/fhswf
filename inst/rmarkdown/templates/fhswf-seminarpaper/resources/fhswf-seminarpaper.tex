...
\def\pagetwo{{\sffamily\setstretch{1}%
  ...
  \vbox to \textheight{%
    ...
    Ich erkläre hiermit, dass folgende Kriterien in dieser Arbeit erfüllt werden \dots \\\\

    \begin{todolist}
    \item Forschungsfrage und zur deren Beantwortung verknüpfte Inhalte
      \begin{todolist}
