...
\def\pagetwo{{\sffamily\setstretch{0.8}%
  ...
  \textbf{\ldots the language is used as follows:}
      ...
      \item Avoid using modal verbs (especially shall and should; Instead of "In this work the following questions should be examined." $\rightarrow$ "In this work the following questions will be examined.")
  ...
  \textbf{\ldots and the following is fulfilled:}
    \begin{itemize}
      ...
      \item All authors have signed personally the declaration of authorship.
      \end{itemize} \\\\
