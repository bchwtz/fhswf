...
\def\pagetwo{{\sffamily\setstretch{0.8}%
  ...
  \textbf{\ldots folgende inhaltliche Kriterien im Hinblick auf die Forschungsfrage erfüllt sind:}
    ...
    \textbf{\ldots  bei der Ergebnisdarstellung Folgendes beachtet wird:}
      ...
      \item Handschriftliche Ergänzungen, Rechnungen und Zeichnungen werden nicht bewertet. Nutzen Sie für die Darstellung von Rechnungen die LaTeX-Notation in RMarkdown. Ersetzen Sie handschriftliche Zeichnungen durch in R erzeugte Diagramme.
      \end{todolist}
  ...
  \textbf{\ldots die Sprache wie folgt gestaltet ist:}
    ...
    The checklist is only available in German! \dots \\\\
