...
\def\pagetwo{{\sffamily\setstretch{1}%
  ...
  \vbox to \textheight{%
    ...
    \begin{todolist}
      ...
      \item Die Arbeit enthält keine "Rechenrezepte".
      \item Jede in der Arbeit enthaltene Grafik ist auch in Textform beschrieben, erläutert und interpretiert. Grafiken ergänzen die textuelle Darstellung und substituieren sie nicht.
      ...
      \item In der Arbeit geannnte Zahlen sind mitsamt deren Einheiten aufgeführt.
      ...
      \item Tabellen- und Abbildungsbeschriftungen sind beschriftet und enden mit einem Punkt.
      ...
      \item Die Arbeit ist frei von Wortem die Präzision vorgeben ohne  Präzise zu sein (z.B. verschieden, manche, bestimmte Zeitpunkten).
      \item Verzichten Sie insb. in der Inhaltsdarstellung auf Modalverben (insb. sollen;  In dieser Arbeit soll --> In dieser Arbeit wird...)
