...
\def\pagetwo{{\sffamily\setstretch{1}%
  ...
  \vbox to \textheight{%
    ...
    + im Hinblick auf die Forschungsfrage und die zu deren Beantwortung verknüpften Inhalte folgendes erfüllt ist:
      \begin{todolist}
      ...
      \end{todolist}
      + bei Ergebnisdarstellung folgendes beachtet wird:
      \begin{todolist}
      ...
      \end{todolist}
      + die Sprache wie folgt gestaltet ist:
      \begin{todolist}
      ...
      \end{todolist}
      + weiterhin folgendes erfüllt ist
      \begin{todolist}
