...
\def\pagetwo{{\sffamily\setstretch{1}%
  ...
  \vbox to \textheight{%
    ...
    \begin{itemize}
    \item folgende inhaltliche Kriterien im Hinblick auf die Forschungsfrage erfüllt sind:
      \begin{todolist}
      ...
      \end{todolist}
    \item bei der Ergebnisdarstellung folgendes beachtet wird:
      \begin{todolist}
      ...
      \item Jede in der Arbeit enthaltene Grafik und Tabelle ist auch in Textform beschrieben, erläutert und interpretiert. Grafiken und Tabellen ergänzen die textuelle Darstellung und substituieren sie nicht. Auf die jeweiligen im Text eingegangenen Grafiken und Tabellen wird an den entsprechenden Stellen verwiesen.
