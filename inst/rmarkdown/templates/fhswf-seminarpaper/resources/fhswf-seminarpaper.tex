...
\def\pagetwo{{\sffamily\setstretch{1}%
  ...
  \vbox to \textheight{%
    ...
    Ich erkläre hiermit, dass in der vorliegenden Arbeit\dots \\\\

    \begin{itemize}
    \item im Hinblick auf die Forschungsfrage und die zu deren Beantwortung verknüpften Inhalte folgendes erfüllt ist:
      \begin{todolist}
      \item Die Arbeit enthält (mindestens) eine eindeutig formulierte Forschungsfrage.
      \item Alle genannten Forschungsfragen werden im Schlussteil der Arbeit umfänglich beantwortet.
      ...
      \end{itemize}
      \item bei Ergebnisdarstellung folgendes beachtet wird:
      \begin{todolist}
      ...
      \item Jede in der Arbeit enthaltene Grafik und Tabelle ist auch in Textform beschrieben, erläutert und interpretiert. Grafiken und Tabellen ergänzen die textuelle Darstellung und substituieren sie nicht. Auf die im Text eingegangen Grafiken und Tabellen wird an den entsprechenden Stellen verwiesen.
      ...
      \end{todolist}
      \item die Sprache wie folgt gestaltet ist:
      \begin{todolist}
      ...
      \end{todolist}
      \item weiterhin folgendes erfüllt ist
      \begin{todolist}
      ...
      \item Alle aufgelisteten Autoren haben die Ehrenwörtliche Erklärung eigenhändig unterschrieben.
...
>>>>>>> f90dee7252357a5c2c2ca64e4f6f5636810a0fae
      \begin{todolist}
    ...
    \begin{todolist}
        \item dass ich die Eidesstattliche Versicherung unterschrieben habe.
        \item xx.
        \begin{todolist}
          \item Sublist item 1 goes here.
          \item Sublist item 2 goes here.
