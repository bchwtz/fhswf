...
#'
#' This dataset contains 1,339 medical insurance records. The individual medical
#' costs billed by health insurance are the variable charges, and the rest of
#' columns contain personal information such as age, gender, family status, and
#' whether the patient smokes among other features.
#'
...
#' }
#' @source \url{https://github.com/stedy/Machine-Learning-with-R-datasets#readme}
#' @source \url{https://www.kaggle.com/datasets/mirichoi0218/insurance}
#'
#' @references Lantz, Brett, "Machine Learning with R", Third Edition, 2019, Packt Publishing.
"insurance"
