...
#'
#' @description
#' TODO: Adriane Sommer & Marc Hoffmann
#'
#' @format A data frame with 18 rows and 14 variables:
#' \describe{
#'   \item{club}{Participating teams in the 1. Bundesliga}
#'   \item{clubabbr}{TODO}
...
#'   \item{marketvalue_goal}{TODO}
#'   \item{marketvalue_a}{TODO}
#'   \item{marketvalue_b}{TODO}
#'   \item{marketvalue_c}{TODO}
